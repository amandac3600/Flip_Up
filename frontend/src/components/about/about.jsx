...
import helenpp from './helenpp.jpeg'
import "./about.css";
      ...
      <div className='about-contrib-container'>
        ...
        <div className='about-contrib'>
          <div className='about-contrib-div'>
            ...
            <p className='about-contrib-descrip'>My favorite sea animals are sea lions!</p>
          ...
          <div className='about-contrib-div'>
            ...
            <p className='about-contrib-descrip'>Hello, I'm Amanda! I am a fullstack software engineer based in Los Angeles, CA. I have experience with many technologies including Ruby on Rails, Node JS, PostgreSQL, MongoDB, React, and Redux, and for Flip Up, I had a great time using HTML and CSS to style the pages. In my free time, I love baking and spending time with my fluffy cat, Boba (can you guess what my favorite drink is?).</p>
          ...
          <div className='about-contrib-div'>
            <img src={helenpp} alt="Helen Edwards" className='about-profile-pic'/>
